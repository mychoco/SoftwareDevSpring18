                ...
                <form id="checkoutForm" action="<c:url value='purchase'/>" method="post">
                    ...
                    <table id="checkoutTable">
                        ...
                        <tr>
                            ...
                            <td class="inputField">
                                <input type="text" size="31" maxlength="45" id="name"
                        ...
                        <tr>
                            ...
                            <td class="inputField">
                                <input type="text" size="31" maxlength="45" id="email"
                        ...
                        <tr>
                            ...
                            <td class="inputField">
                                <input type="text" size="31" maxlength="16" id="phone"
                        ...
                        <tr>
                            ...
                            <td class="inputField">
                                <input type="text" size="31" maxlength="45" id="address"
                                ...
                                <select name="cityRegion">
                                    <c:forEach begin="1" end="10" var="regionNumber">
                                        <option value="${regionNumber}"
                                                <c:if test="${param.cityRegion eq regionNumber}">selected
                                                </c:if>>${regionNumber}</option>
                                    </c:forEach>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="inputField">
                                <input type="text" size="31" maxlength="19" id="creditcard"
                                       name="creditcard" value="${param.creditcard}">
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"><input type="submit" value="<fmt:message key='submit'/>"></td>
                        </tr>
                    ...
                    <table id="priceBox">
                        ...
                        <tr>
                            ...
                            <td class="total checkoutPriceColumn">
                                <fmt:formatNumber type="currency" currencySymbol="&euro; " value="${cart.total}"/>
                            </td>
                        </tr>
                    </table>
                </div>
