<c:set var='view' value='/cart' scope='session'/>
            <div id="singleColumn">
                ...
                <c:if test="${!empty cart && cart.numberOfItems != 0}">
                    ...
                    <h4 id="subtotal"><fmt:message key="subtotal"/>: <fmt:formatNumber type="currency" currencySymbol="&euro; " value="${cart.subtotal}"/></h4>
                    ...
                    <table id="cartTable">
                        ...
                        <c:forEach var="cartItem" items="${cart.items}" varStatus="iter">
                            ...
                            <tr class="${((iter.index % 2) == 0) ? 'lightBlue' : 'white'}">
                                <td>
                                    <img src='${initParam.productImagePath}${product.name}.png' alt='<fmt:message key="${product.name}"/>'>
                                </td>
                                ...
                                <td>
                                    ...
                                    <br>
                                    <span class='smallText'>( <fmt:formatNumber type="currency" currencySymbol="&euro; " value="${product.price}"/> / <fmt:message key="unit"/> )</span>
                                </td>
